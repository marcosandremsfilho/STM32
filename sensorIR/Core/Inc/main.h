...
#define Debug_LED2_EXTI_IRQn EXTI9_5_IRQn
#define Debug_LED3_Pin GPIO_PIN_0
#define Debug_LED3_GPIO_Port GPIOB
#define Debug_LED4_Pin GPIO_PIN_1
#define Debug_LED4_GPIO_Port GPIOB
#define IRControllerPin_Pin GPIO_PIN_8
#define IRControllerPin_GPIO_Port GPIOB
#define IRControllerPin_EXTI_IRQn EXTI9_5_IRQn
