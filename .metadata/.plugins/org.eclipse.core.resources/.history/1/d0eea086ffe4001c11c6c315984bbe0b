...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  	...
	  	HAL_GPIO_ReadPin(GPIO_Sens1_GPIO_Port, GPIO_Sens1_Pin);
	  	HAL_GPIO_ReadPin(GPIO_Sens2_GPIO_Port, GPIO_Sens2_Pin);
	  	HAL_GPIO_ReadPin(GPIO_Sens3_GPIO_Port, GPIO_Sens3_Pin);
